...
|---|---|---|
| `guid` | String | lower‑cased CLSID identifying the COM class |
| `description` | String | human‑readable description of the COM class |
| `executable` | String | path(s) to the binary(ies) implementing the CLSID (e.g., InprocServer32, LocalServer32) |
| `treat_as` | String | CLS ID that this entry redirects to via TreatAs |
