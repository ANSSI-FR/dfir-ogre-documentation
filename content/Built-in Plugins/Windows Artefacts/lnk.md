...
| `extra.distributed_link_tracker.droid_volume_identifier` | StringToLower | Two values (a priori droid_volume_identifier and droid_file_identifier) in GUID packet representation that are used to find the link target with the Link Tracking service. |
...
| `extra.distributed_link_tracker.birth_droid_volume_identifier` | StringToLower | Two values (a priori birth_droid_volume_identifier et birth_droid_file_identifier) in GUID packet representation that are used to find the link target with the Link Tracking service. |
...
| `link_info` | Object |  |
| `link_info.local_base_path` | String |  |
| `link_info.common_path_suffix` | String |  |
