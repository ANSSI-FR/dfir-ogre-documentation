...
|---|---|---|
| `run_time` | DateTime | timestamp when the program was launched |
...
| `software_vendor` | String | name of the software vendor or publisher |
| `file_version` | String | version of the executable |
| `program_id` | String | unique identifier for the program |
| `exitcode_value` | String | exit code returned by the program after execution |
