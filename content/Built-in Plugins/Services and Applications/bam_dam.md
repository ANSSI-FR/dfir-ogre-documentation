...
|---|---|---|
| `exec_path` | String | full path of the executable that was run |
| `user_sid` | String | SID of the user associated with the BAM/DAM entry |
| `exec_time` | DateTime | timestamp when the executable was last executed |
