...
| `modification_time` | DateTime | UTC modification timestamp converted from the shell item's DOS/FAT local time using the matching SYSTEM hive |
| `access_time` | DateTime | UTC access timestamp converted from the shell item's DOS/FAT local time using the matching SYSTEM hive |
| `creation_time` | DateTime | UTC creation timestamp converted from the shell item's DOS/FAT local time using the matching SYSTEM hive |
