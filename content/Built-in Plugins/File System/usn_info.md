...
| `usn_number` | IntRadix | USN (Update Sequence Number) in hexadecimal |
...
| `file` | String | name of the file or directory (no path) |
| `file_path` | String | full path of the file or directory |
